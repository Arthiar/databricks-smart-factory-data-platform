...
# MAGIC %md
# MAGIC # Bronze Auto Loader - Production.Location
# MAGIC
# MAGIC Incrementally ingests the official Microsoft AdventureWorks `Location.csv` source file from the governed ADLS landing volume into the Bronze Delta table.
# MAGIC
...
location_schema = StructType([
    ...
    StructField("CostRate", StringType(), True),
    StructField("Availability", StringType(), True),
    StructField("ModifiedDate", StringType(), True)
])

print(f"Schema contains {len(location_schema.fields)} raw source columns.")
...
print("Bronze ingestion completed: Production.Location")

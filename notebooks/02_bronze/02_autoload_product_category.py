...
# MAGIC %md
# MAGIC # Bronze Auto Loader - Production.ProductCategory
# MAGIC
# MAGIC Incrementally ingests the official Microsoft AdventureWorks `ProductCategory.csv` source file from the governed ADLS landing volume into the Bronze Delta table.
# MAGIC
...
print(f"Schema contains {len(product_category_schema.fields)} raw source columns.")
...
print("Bronze ingestion completed: Production.ProductCategory")

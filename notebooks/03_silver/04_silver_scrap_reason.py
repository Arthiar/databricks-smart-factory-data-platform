...
# MAGIC %md
# MAGIC # Silver - Scrap Reason
# MAGIC
# MAGIC Cleans, validates, quarantines, deduplicates, and upserts the Bronze `scrap_reason` table.
...
rejection_expression = (
    F.when(F.col("ScrapReasonID").isNull(), F.lit("ScrapReasonID is null or invalid"))

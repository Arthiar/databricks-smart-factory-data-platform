...
# MAGIC %md
# MAGIC # Silver - Product Category
# MAGIC
# MAGIC Cleans, validates, quarantines, deduplicates, and upserts the Bronze `product_category` table.
...
rejection_expression = (
    F.when(F.col("ProductCategoryID").isNull(), F.lit("ProductCategoryID is null or invalid"))

...
# MAGIC
# MAGIC Cleans, validates, quarantines, deduplicates, and upserts the Bronze `customer` table.
...
typed_df = (
    ...
    .select(
        ...
        try_int("PersonID").alias("PersonID"),
        try_int("StoreID").alias("StoreID"),
...
rejection_expression = (
    F.when(F.col("CustomerID").isNull(), F.lit("CustomerID is null or invalid"))
